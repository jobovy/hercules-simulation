...
\caption{Velocity distribution of nearby ($\lesssim 100$ pc) stars
...
\clearpage
\begin{figure}
\includegraphics[width=0.32\textwidth]{distuncertain.ps}
\includegraphics[width=0.32\textwidth]{vlosuncertain.ps}
\includegraphics[width=0.32\textwidth]{df.ps}\\
\includegraphics[width=0.32\textwidth]{slope.ps}
\includegraphics[width=0.32\textwidth]{rolr.ps}
\includegraphics[width=0.32\textwidth]{barstrength.ps}
\caption{Variation of the predicted velocity distribution at $R$ =
  1.075 \Ro , $\phi = -21^{\circ}$ ($d$= 0.4 \Ro, $l$ = 270$^{\circ}$)
  with distance uncertainties; line-of-sight velocity uncertainties;
  parameters and shape of the distribution function; shape of the
  rotation curve; bar \Rolr; and bar strength.}\label{fig:1dvar}
\end{figure}
