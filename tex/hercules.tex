...
directions. I quantify the most promising lines-of-sight for the
detection of the Hercules stream in radial velocities: The most
promising directions to target are at $l \geq 250^{\circ}$. The
predictions presented here are only weakly affected by distance
uncertainties, assumptions about the distribution function of the old
