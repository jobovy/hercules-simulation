...
throughout a volume of 500 pc or more.

The bottom two panels of \figurename~\ref{fig:1dvar} show that the
...
the expected data, it is clear that constraints on the bar can be
derived from the experiment proposed in this paper.
