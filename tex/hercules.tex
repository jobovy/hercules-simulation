...
picture beyond the locallly observed kinematics of stars remains
...
the bar \citep[\eg,][]{binney97a,bissantz02a,cole02a,Shen10a}. In what
follows, unless indicated otherwise, we fix all of the parameters of
the model at these fiducial values.
...
bar-resonance predictions. These predictions are also largely a
function of the particular form and parameters of the distribution
function that we chose the represent the stellar disk before bar
formation.
...
\caption{The velocity distribution of nearby ($\lesssim 100$ pc) stars
  ...
  respectively. The Hercules moving group is visible as an overdensity
  at \vphi $\approx$ -0.2 $\vo$.}\label{fig:obs}
\end{figure}
